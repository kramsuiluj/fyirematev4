                                ...
                                <div class="overflow-auto">
                                    ...
                                    text-left font-barlowcondensed">
                                            ...
                                            flex space-x-2">
                                                    ...
                                                    <a @click.prevent="show = !show" id="delete-button" href="#" class="text-red-700"
                                                       title="Delete Certificate"
                                                    >
                                                        <x-icon name="delete"></x-icon>

                                                        <form id="delete-{{ $io->id }}" action="{{ route('ios.destroy', [$certificate->id, $io->id]) }}" method="POST" style="display: none">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                    </a>
