        ...
        <x-containers.content>
            <form method="GET" action="">
                <div class="relative">
                    ...
                    dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" value="{{ request
                    ('search') ?? '' }}"
                           required>
                    @if(request('search'))
                        <a href="{{ route('admin.activities.index') }}" class="absolute top-0 right-0 mr-24 mt-4">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                 xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                        </a>
                    @endif
