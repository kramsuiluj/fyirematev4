<x-layout>
    ...
    <x-containers.main>
        <x-containers.sub-header>
            ...
            <span class="cursor-pointer font-barlowcondensed underline">Chiefs</span>
            <x-icon name="right-arrow"/>
            ...
            <div class="grid grid-cols-6 px-10 py-5">
                ...
                <section x-data="{ show: false }" id="fields" class="grid grid-rows-6 gap-3 col-span-4">
                    ...
                    <div>
                        ...
                        @enderror" form="update-personnel" value="{{ old('title') ?? $chief->title }}">
                    </div>
                    <div>
                    ...
                    <div>
                        <input type="text" name="lastname" placeholder="ex. Doe" class="font-varela bg-gray-50 border
                         ...
                         @enderror" form="update-personnel" value="{{ old('lastname') ?? $chief->lastname }}" required>
                    </div>
        ...
        <form action="{{ route('admin.personnel.chiefs.update', $chief->id) }}" method="POST" style="display:none;"
              id="update-personnel">
            @csrf
            @method('PATCH')
        </form>
